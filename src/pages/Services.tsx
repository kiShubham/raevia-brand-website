        ...
        <div className="mb-12 animate-fade-up">
            ...
            <div className="bg-card/30 backdrop-blur-md rounded-lg overflow-hidden border border-border/50 shadow-xl">
                ...
                <div className="grid grid-cols-12 gap-4 p-4 md:p-6 bg-secondary/40 text-accent font-serif tracking-widest uppercase text-sm md:text-base border-b border-border/50">
                    ...
                    <div className="col-span-3 md:col-span-3 text-right">{category.headers[1]}</div>
                    {category.headers[2] && (
                        <div className="col-span-3 md:col-span-3 text-right">{category.headers[2]}</div>
                    )}
                </div>
            ...
            <section className="relative h-[60vh] w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 text-center max-w-4xl px-6 animate-fade-up">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground/90 max-w-2xl mx-auto font-light leading-relaxed">
                        Meticulously curated treatments designed to rejuvenate, refine, and reveal your natural radiance.
                    </p>
                </div>
            </section>
            ...
            <section className="container mx-auto px-4 md:px-8 py-20">
                <Tabs defaultValue={activeTab} className="w-full max-w-5xl mx-auto">
                    ...
                    <TabsContent value="her" className="animate-fade-up">
                        ...
                        <div className="-mt-8"><ServiceTable category={nailArtFeet} /></div>
                        ...
                        <h3 className="text-3xl md:text-4xl font-serif text-foreground mb-12 text-center">Hair Treatments</h3>
